...
class PsColors {
  ...
  /// Common Theme
  ///
  static const Color _c_main_color = Color(0xFFFA8072);
  static const Color _c_main_light_color = Color(0xFFFEEDEB);
  static const Color _c_main_dark_color = Color(0xFFF86355);
