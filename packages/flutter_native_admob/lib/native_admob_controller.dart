...
class NativeAdmobController {
  ...
  final StreamController<AdLoadState> _stateChanged = StreamController<AdLoadState>.broadcast();
  Stream<AdLoadState> get stateChanged => _stateChanged.stream;

  /// Channel to communicate with plugin
  // final MethodChannel _pluginChannel = const MethodChannel('flutter_native_admob');
