...
class Distance implements DistanceCalculator {
    ...
    double bearing(final LatLng p1, final LatLng p2) {
        final double diffLongitude = p2.longitudeInRad - p1.longitudeInRad;

        final double y = math.sin(diffLongitude);
        final double x = math.cos(p1.latitudeInRad) * math.tan(p2.latitudeInRad) -
