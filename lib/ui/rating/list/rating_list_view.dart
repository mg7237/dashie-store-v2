...
import 'package:flutterstore/ui/common/base/ps_widget_with_appbar_with_two_provider.dart';
...
import 'package:flutterstore/ui/rating/entry/rating_input_dialog.dart';
            ...
            child: Consumer<RatingProvider>(builder: (BuildContext context,
              ...
              return Container(
                ...
                child: RefreshIndicator(
                  ...
                  onRefresh: () {
                    return ratingProvider
                        .resetRatingList(widget.productDetailid);
                  },
                ),
              );
            })));
