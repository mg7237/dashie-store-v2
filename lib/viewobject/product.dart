...
import 'package:flutterstore/viewobject/rating_detail.dart';
...
class Product extends PsObject<Product> {
  ...
  Product fromMap(dynamic dynamicData) {
    if (dynamicData != null) {
      return Product(
          ...
          itemSpecList: ProductSpecification().fromMapList(dynamicData['specs']),
          ...
          attributesHeaderList: AttributeHeader().fromMapList(dynamicData['attributes_header']),
  ...
  Map<String, dynamic> toMap(dynamic object) {
    if (object != null) {
      ...
      data['attributes_header'] = AttributeHeader().toMapList(object.attributesHeaderList);
