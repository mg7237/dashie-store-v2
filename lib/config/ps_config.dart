...
class PsConfig {
  ...
  ///
  static const String ps_base_url = 'https://www.panacea-soft.com/flutter-store-admin';

  static const String ps_app_url = ps_base_url + '/index.php/';

  static const String ps_app_image_url = ps_base_url + '/uploads/';

  static const String ps_app_image_thumbs_url = ps_base_url + '/uploads/thumbnail/';
